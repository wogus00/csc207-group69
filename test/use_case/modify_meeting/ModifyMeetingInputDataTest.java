...
class ModifyMeetingInputDataTest {
    private ModifyMeetingInputData inputData;
    ...
    @BeforeEach
    void setUp() {
        inputData = new ModifyMeetingInputData(meetingName, participantEmail, meetingDate, startTime, endTime, projectName);
    }

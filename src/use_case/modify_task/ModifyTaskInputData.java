...
/**
 * Input Data class representing the data inputted by user for modifying a task.
 * This class encapsulates the necessary information to modify a task.
 */
public class ModifyTaskInputData {
    ...
    /**
     * Constructor method that creates new ModifyTaskInputData with specified information needed when modifying task.
     *
     ...
     */
    public ModifyTaskInputData(String projectName, String taskName, String supervisor, String workingMembers, String deadline, String comments) {
    ...
    /**
     * Getter method to return name of the project from ModifyTaskInputData.
     *
    ...
    /**
     * Getter method to return name of the task from ModifyTaskInputData.
     *
     * @return String of name of the task that will be modified.
     */
    ...
    /**
     * Getter method to return email of the supervising user from ModifyTaskInputData.
    ...
    /**
     * Getter method to return additional comments from ModifyTaskInputData.
     *
    ...
    /**
     * Getter method to return deadline of the task from ModifyTaskInputData.
     *
    ...
    /**
     * Getter method to return emails of responsible users from ModifyTaskInputData.
     *
    ...
    /**
     * Getter method to return completion status from ModifyTaskInputData.
     *

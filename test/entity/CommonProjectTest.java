...
public class CommonProjectTest {

    @Test
    public void testCommonProjectConstructorAndGetters() {
        ...
        CommonProject project = new CommonProject(projectName, leaderEmail, memberEmails);

...
public class CreateMeetingState {
    ...
    /**
     * Setter method to set meetingName as the title of the meeting to be created.
     ...
     * @param meetingNameError String indicating that an error occurred during meeting creation.
     */

...
public class CommonMeetingTest {

    @Test
    public void testCommonMeetingConstructorAndGetters() {
        // Arrange
        ...
        // Act
        CommonMeeting meeting = new CommonMeeting(meetingName, participantEmail, meetingDate, startTime, endTime, projectName);

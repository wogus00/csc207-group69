...
class CreateMeetingOutputDataTest {

    private CreateMeetingOutputData outputData;
    ...
    @BeforeEach
    void setUp() {
        outputData = new CreateMeetingOutputData(meetingName, participantEmail, meetingDate, startTime, endTime, projectName);
    }
